(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Monsoon-https://monsoonmalabar.com/earthcoconutoil-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.currency = "MYR"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "MYR"; // Currency symbol as textual string
		...
		sendEmail: function() {
			if( this.$checkoutCart.length && this.$userDetails.length ) {
				...
				if( items.length == 0 ) {
					...
					var uemail = 'shangkery24@gmail.com';
